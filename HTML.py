        ...
        return f'''<!doctype html>
                        <html lang="en">
                          ...
                          <body>
                            ...
                            <h2 align="center">на участии в миссии</h2>
                            <div>
    ...
    return f"""<!doctype html>
                <html lang="en">
                  ...
                  <body>
                    ...
                    <h2>Претендента в участие в миссии {nickname}</h2>
                    <div class="alert alert-primary" role="alert">
                      Поздравляем! Ваш рейтинг после {level} этапа отбора
                    </div>
                    <label>составляет {rating}!</label>
                    <div class="alert alert-info" role="alert">
                      Желаем удачи!
                    </div>
                  </body>
...
def photo():
    if request.method == 'GET':
        return f'''<!doctype html>
                        <html lang="en">
                          ...
                          <body>
                            ...
                            <h2 align="center">для участии в миссии</h2>
                            <div>
                                <form>
                                    <div class="form-group">
                                        <label for="photo">Приложите фотографию</label>
                                    ...
                                    <img src="{url_for('static', filename='img/MARS.png')}" alt="">
                                    <button type="submit" class="btn btn-primary">Отправить</button>
                                </form>
                            </div>
                          </body>
        ...
        with open('photo.jpeg', 'w') as img:
            with open(request.form['file'], 'r') as file:
                img.write(file)
